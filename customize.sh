...
ui_print ""
ui_print "=============================="
ui_print "  Plasma Mobile Theme v1.1.2"
...
ui_print "  3. Samsung One UI launcher disabled (NOT hidden — reversible)"
...
ui_print ""
ui_print "To bring back Samsung One UI Home from within the launcher:"
ui_print "  Call Android.restoreOneUIHome() via the JS bridge"
ui_print "  (re-enables it, hands back the HOME role, restarts SystemUI)"
ui_print "  If Plasma never loads, run as root instead:"
ui_print "    pm enable com.sec.android.app.launcher"
ui_print "    cmd role remove-role-holder android.app.role.HOME msr.plasma 0"
ui_print "    cmd role add-role-holder android.app.role.HOME com.sec.android.app.launcher 0"
ui_print ""
